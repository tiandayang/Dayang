...
extension Date {
    ...
    ///
    /// - Returns: 天数
    public func dayIndexSince1970() -> Int {
    ...
    ///
    /// - Returns: 天数
    public func dayIndexSinceNow() -> Int {
    ...
    ///
    /// - Returns: timeString
    public func stringWithNoSeconds() -> String {
    ...
    ///
    /// - Returns: date
    public func dateAccurateToDay() -> Date? {
    ...
    ///
    /// - Returns: date
    public func dateAccurateToHour() -> Date? {
